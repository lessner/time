...
<header id="header">
    <div class="container-fluid">
        ...
        <div id="logo" class="pull-left">
            <h1><a href="#intro" class="scrollto">EquateClock</a></h1>
...
<footer id="footer">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class="ion-ios-arrow-right"></i> <a href="#">Términos de Servicio</a></li>
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    ...
                    <p>
                        ...
                        Honduras <br>
                        <strong>Teléfono:</strong> +504 9999-9999<br>
                        <strong>Email:</strong> info@equatepro.com<br>
                    </p>
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong>EquatePro</strong>. Todos los derechos reservados.
        </div>
        <div class="credits">
            <!--
