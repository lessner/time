        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>EquateClock</strong> Login</h1>
...
<!-- Javascript -->
<script src="js/login/jquery-1.11.1.js"></script>
<script src="css/bootstrap/js/bootstrap.min.js"></script>
<script src="js/login/jquery.backstretch.js"></script>
